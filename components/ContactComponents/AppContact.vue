    ...
    <div class="mx-auto max-w-7xl py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
      <div class="relative bg-white shadow-xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3">
          <!-- Contact information -->
          <div
            class="relative overflow-hidden bg-indigo-700 py-10 px-6 sm:px-10 xl:p-12"
          >
            <div
            ...
            <p class="mt-6 max-w-3xl text-base text-indigo-50">
              Lorem Ipsum nullam risus blandit ac aliquam justo ipsum. Quam
              mauris volutpat massa dictumst amet. Sapien tortor lacus arcu.
            </p>
            <dl class="mt-8 space-y-6">
              ...
              <dd class="flex text-base text-indigo-50">
                <PhoneIcon
                  ...
                  aria-hidden="true"
                />
                <span class="ml-3">+ (251) 11-472-0802</span>
              </dd>
              ...
              <dd class="flex text-base text-indigo-50">
                <EnvelopeIcon
                  ...
                  aria-hidden="true"
                />
                <span class="ml-3">unitedtruckinget@gmail.com</span>
              </dd>
            </dl>
